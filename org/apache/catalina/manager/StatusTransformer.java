  ...
  public static void writeOSState(PrintWriter writer, int mode)
  {
    ...
    if (ok) {
      if (mode == 0)
      {
        ...
        writer.print(formatTime(Long.valueOf(result[11] / 1000L), true));
        writer.print(" Process user time: ");
        writer.print(formatTime(Long.valueOf(result[12] / 1000L), true));
        writer.print("</p>");
      }
      else if (mode != 1) {}
    }
...
/* Location:              D:\F\阿里云架构开发\taobao-tomcat-7.0.59\taobao-tomcat-7.0.59\lib\catalina.jar!\org\apache\catalina\manager\StatusTransformer.class
